...
module sar_logic ( clk_sar, en, sample, value, result_out, cmp, cmp_clk );
  ...
  DFFQ_X1N_A10P5PP84TR_C14 result_reg_7_ ( .D(netsm_43), .CK(clk_sar), .Q(result[7]) );
  DFFQ_X1N_A10P5PP84TR_C14 result_reg_6_ ( .D(netsm_42), .CK(clk_sar), .Q(result[6]) );
  DFFQ_X1N_A10P5PP84TR_C14 result_reg_5_ ( .D(netsm_41), .CK(clk_sar), .Q(result[5]) );
  DFFQ_X1N_A10P5PP84TR_C14 result_reg_4_ ( .D(netsm_40), .CK(clk_sar), .Q(result[4]) );
  DFFQ_X1N_A10P5PP84TR_C14 result_reg_3_ ( .D(netsm_39), .CK(clk_sar), .Q(result[3]) );
  DFFQ_X1N_A10P5PP84TR_C14 result_reg_2_ ( .D(netsm_38), .CK(clk_sar), .Q(result[2]) );
  DFFQ_X1N_A10P5PP84TR_C14 result_reg_1_ ( .D(netsm_37), .CK(clk_sar), .Q(result[1]) );
  DFFQ_X1N_A10P5PP84TR_C14 result_reg_0_ ( .D(netsm_45), .CK(clk_sar), .Q(result[0]) );
  ...
  DFFQ_X1N_A10P5PP84TR_C14 mask_reg_7_ ( .D(netsm_29), .CK(clk_sar), .Q(mask[7]) );
  DFFQ_X1N_A10P5PP84TR_C14 mask_reg_6_ ( .D(netsm_30), .CK(clk_sar), .Q(mask[6]) );
  DFFQ_X1N_A10P5PP84TR_C14 mask_reg_5_ ( .D(netsm_31), .CK(clk_sar), .Q(mask[5]) );
  DFFQ_X1N_A10P5PP84TR_C14 mask_reg_4_ ( .D(netsm_32), .CK(clk_sar), .Q(mask[4]) );
  DFFQ_X1N_A10P5PP84TR_C14 mask_reg_3_ ( .D(netsm_33), .CK(clk_sar), .Q(mask[3]) );
  DFFQ_X1N_A10P5PP84TR_C14 mask_reg_2_ ( .D(netsm_34), .CK(clk_sar), .Q(mask[2]) );
  DFFQ_X1N_A10P5PP84TR_C14 mask_reg_1_ ( .D(netsm_35), .CK(clk_sar), .Q(mask[1]) );
  DFFQ_X1N_A10P5PP84TR_C14 mask_reg_0_ ( .D(netsm_36), .CK(clk_sar), .Q(mask[0]) );
  INVP_X0P6F_A10P5PP84TR_C14 I_1 ( .A(clk_sar), .Y(netlg_59) );
  DFFQN_X1N_A10P5PP84TR_C14 value_rst_reg_0_ ( .D(netsm_44), .CK(clk_sar), .QN(netsm_73)
         );
  AND2_X0P6N_A10P5PP84TR_C14 U57 ( .A(netlg_59), .B(netsm_46), .Y(cmp_clk) );
  BUF_X0P6R_A10P5PP84TR_C14 U58 ( .A(en), .Y(netsm_46) );
  BUF_X0P6R_A10P5PP84TR_C14 U59 ( .A(netsm_52), .Y(netsm_47) );
  BUF_X0P6R_A10P5PP84TR_C14 U60 ( .A(netsm_73), .Y(netsm_48) );
  NOR2_X0P4N_A10P5PP84TR_C14 U61 ( .A(state[0]), .B(state[1]), .Y(sample) );
  OAI21_X0P4N_A10P5PP84TR_C14 U62 ( .A0(sample), .A1(netsm_48), .B0(netsm_46), .Y(netsm_44)
         );
  NAND2_X0P4N_A10P5PP84TR_C14 U63 ( .A(en), .B(state[0]), .Y(netsm_51) );
  INVP_X0P6F_A10P5PP84TR_C14 U64 ( .A(mask[0]), .Y(netsm_72) );
  NAND2_X0P4N_A10P5PP84TR_C14 U65 ( .A(netsm_46), .B(state[1]), .Y(netsm_52) );
  OAI21_X0P4N_A10P5PP84TR_C14 U66 ( .A0(netsm_51), .A1(netsm_72), .B0(netsm_47), .Y(netsm_27) );
  INVP_X0P6F_A10P5PP84TR_C14 U67 ( .A(mask[7]), .Y(netsm_70) );
  NAND2_X0P4N_A10P5PP84TR_C14 U68 ( .A(en), .B(sample), .Y(netsm_49) );
  OAI21_X0P4N_A10P5PP84TR_C14 U69 ( .A0(netsm_52), .A1(netsm_70), .B0(netsm_49), .Y(netsm_29) );
  AO21A1AI2_X0P4N_A10P5PP84TR_C14 U70 ( .A0(state[0]), .A1(state[1]), .B0(
        sample), .C0(netsm_46), .Y(netsm_50) );
  OAI21_X0P4N_A10P5PP84TR_C14 U71 ( .A0(mask[0]), .A1(netsm_51), .B0(netsm_50), .Y(netsm_28)
         );
  NOR2_X0P4N_A10P5PP84TR_C14 U72 ( .A(state[1]), .B(netsm_51), .Y(netsm_54) );
  INVP_X0P6F_A10P5PP84TR_C14 U73 ( .A(netsm_54), .Y(netsm_53) );
  INVP_X0P6F_A10P5PP84TR_C14 U74 ( .A(mask[1]), .Y(netsm_58) );
  OAI22_X0P4N_A10P5PP84TR_C14 U75 ( .A0(netsm_72), .A1(netsm_52), .B0(netsm_53), .B1(netsm_58), 
        .Y(netsm_36) );
  INVP_X0P6F_A10P5PP84TR_C14 U76 ( .A(mask[2]), .Y(netsm_68) );
  OAI22_X0P4N_A10P5PP84TR_C14 U77 ( .A0(netsm_53), .A1(netsm_68), .B0(netsm_58), .B1(netsm_52), 
        .Y(netsm_35) );
  INVP_X0P6F_A10P5PP84TR_C14 U78 ( .A(mask[6]), .Y(netsm_62) );
  INVP_X0P6F_A10P5PP84TR_C14 U79 ( .A(mask[5]), .Y(netsm_60) );
  ...
  OAI22_X0P4N_A10P5PP84TR_C14 U81 ( .A0(netsm_53), .A1(netsm_70), .B0(netsm_62), .B1(netsm_52), 
        .Y(netsm_30) );
  INVP_X0P6F_A10P5PP84TR_C14 U82 ( .A(mask[3]), .Y(netsm_64) );
  OAI22_X0P4N_A10P5PP84TR_C14 U83 ( .A0(netsm_53), .A1(netsm_64), .B0(netsm_68), .B1(netsm_52), 
        .Y(netsm_34) );
  INVP_X0P6F_A10P5PP84TR_C14 U84 ( .A(mask[4]), .Y(netsm_66) );
