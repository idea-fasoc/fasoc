...
## sar
inFile0 = open(genDir + "./0_net_template/sar").read()

inFile0 = inFile0.replace('@value', value)
inFile0 = inFile0.replace('@result_out', result_out)

outFile0 = open(srcDir + "/sar_autogenerated.cdl", "w")
...
## sar verilog
inFile0_v = open(genDir + "./0_net_template/sar_v").read()
...
print(genDir)
outFile0_v = open(genDir + "/src/sar_autogenerated.v", "w")
...
## cdac
inFile1 = open(genDir + "./0_net_template/cdac").read()
...
outFile1 = open(srcDir + "/cdac_autogen_temp", 'w')
outFile1.write(inFile1)
outFile1.close()

r_file = open(srcDir + "/cdac_autogen_temp", "r")
lines = r_file.readlines()


w_file0 = open(srcDir + "/cdac_autogenerated.cdl", "w")
...
## cdac verilog
inFile1_v = open(genDir + "./0_net_template/cdac_v").read()
...
outFile1_v = open(srcDir + "/cdac_autogen_temp_v", 'w')
outFile1_v.write(inFile1_v)
outFile1_v.close()

r_file_v = open(srcDir + "/cdac_autogen_temp_v", "r")
lines = r_file_v.readlines()


w_file0_v = open(srcDir + "/cdac_autogenerated.v", "w")
...
## dac
inFile3 = open(genDir + "./0_net_template/dac").read()

inFile3 = inFile3.replace('@NBIT',str(NBIT))

outFile3 = open(srcDir + "/dac_autogenerated.va", "w")
outFile3.write(inFile3)
outFile3.close()


## copy netlist
shutil.copy2(genDir + "./0_net_template/comp_nand.cdl", srcDir)
shutil.copy2(genDir + "./0_net_template/comp_nand.v", srcDir)
shutil.copy2(genDir + "./0_net_template/sar_logic_syn.v", srcDir)
