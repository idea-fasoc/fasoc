...
module tstdc_counter(
	...
	parameter pre_ls_ref_NSTG_CC_TUNE=2; 
	parameter pre_ls_ref_NCC_TUNE 	=2;
	parameter pre_ls_ref_NFC	=63;
	...
	parameter post_ls_ref_NSTG_CC_TUNE=2;
	parameter post_ls_ref_NCC_TUNE	=2;
	parameter post_ls_ref_NFC	=63;
	...
	parameter pre_es_fb_NSTG_CC_TUNE=2;
	parameter pre_es_fb_NCC_TUNE	=2;
	parameter pre_es_fb_NFC		=63;
	...
	parameter post_es_fb_NSTG_CC_TUNE=2;
	parameter post_es_fb_NCC_TUNE	=2;
	parameter post_es_fb_NFC	=63;
	...
	parameter dltdc_NFC_fb = 4;
	parameter dltdc_NFC_ref = 4;
	parameter dltdc_NDRV_fb = 2;
	parameter dltdc_NDRV_ref = 2;
	parameter dltdc_NCC_fb = 2;
	...
	parameter pre_NSTG_ref_ls = 18; // 1001 update 
	parameter pre_NSTG_ref = 30; // dltdc ref in @ 17*6 = 102ps
	//parameter pre_NSTG_fb = 8; // edge arrives @ 17*1 = 17ps
	parameter pre_NSTG_fb = 12; // 1001 update 
	parameter ppath_NSTG = 3; // ppath (ppath_NSTG)*delay
	...
	parameter TDC_NUM_RETIME_CYCLES = 8; // 0603
...
module tstdc_encoder (
	...
	// Behavioral
		...
		assign DLTDC_IN_rm_lsb = DLTDC_IN >> 1; // 0603
