...
def gen_tb_wrapped(hspiceModel,tb_dir,format_dir,ncell,ndrv,nfc,nstg,vdd,temp,fc_en_type,sim_time,corner_lib,designName,netlistDir,finesim,single_ended,FC_half,pex_spectre,tapeout_mode):
	...
	if pex_spectre==0:
		if finesim==0:
			...
			if tapeout_mode==0:
				...
				if single_ended==1:
					if FC_half==0:
						r_file=open(format_dir+"form_fs_pex_tb_dco_se_to.sp","r")
					elif FC_half==1:
						r_file=open(format_dir+"form_fs_pex_tb_dco_se_to_halfFC.sp","r")
				else:
					print("ERROR: tapeout mode is currently supported only for single ended and full FC")
					sys.exit(1)
	elif pex_spectre==1:
		if finesim==0:
			if single_ended==0:
	...
	if tapeout_mode==1: # customized testing points for tapeout
		if fc_en_type==1:
			...
			for i in range(1,len(vm2.comblist[0])):
				var_list=[[[] for x in range(15)] for y in range(len(vm2.comblist[0])-1)] # change here!
				#var_list[i-1][0]=[0,N_ctrl_fc,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][1]=[0,0,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][2]=[1,N_ctrl_fc,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][3]=[N_ctrl_cc//2,N_ctrl_fc,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][0]=[N_ctrl_cc//2,N_ctrl_fc//2-3,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][1]=[N_ctrl_cc//2,N_ctrl_fc//2-2,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][2]=[N_ctrl_cc//2,N_ctrl_fc//2-1,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][3]=[N_ctrl_cc//2,N_ctrl_fc//2,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][4]=[N_ctrl_cc//2,N_ctrl_fc//2+1,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][5]=[N_ctrl_cc//2,N_ctrl_fc//2+2,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][6]=[N_ctrl_cc//2,N_ctrl_fc//2+3,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][7]=[N_ctrl_cc//2,N_ctrl_fc//2+4,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][8]=[N_ctrl_cc//2,N_ctrl_fc//2+5,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][9]=[N_ctrl_cc//2,N_ctrl_fc//2+6,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][10]=[N_ctrl_cc//2,N_ctrl_fc//2+7,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][11]=[N_ctrl_cc//2,N_ctrl_fc//2+8,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][12]=[N_ctrl_cc//2,0,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][13]=[N_ctrl_cc//2+1,N_ctrl_fc,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][14]=[N_ctrl_cc,0,vm2.comblist[0][i],vm2.comblist[1][i]]
		elif FC_half==1:
			for i in range(1,len(vm2.comblist[0])):
				#var_list=[[[] for x in range(25)] for y in range(len(vm2.comblist[0])-1)] # change here!
				#var_list[i-1][0]=[N_ctrl_cc//2,N_ctrl_fc,N_ctrl_fc,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][1]=[N_ctrl_cc//2,N_ctrl_fc//2,N_ctrl_fc//2,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][2]=[N_ctrl_cc//2,N_ctrl_fc//2,N_ctrl_fc//2+1,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][3]=[N_ctrl_cc//2,N_ctrl_fc//2+1,N_ctrl_fc//2+1,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][4]=[N_ctrl_cc//2,N_ctrl_fc//2+1,N_ctrl_fc//2+2,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][5]=[N_ctrl_cc//2,N_ctrl_fc//2+2,N_ctrl_fc//2+2,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][6]=[N_ctrl_cc//2,N_ctrl_fc//2+2,N_ctrl_fc//2+3,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][7]=[N_ctrl_cc//2,N_ctrl_fc//2+3,N_ctrl_fc//2+3,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][8]=[N_ctrl_cc//2,N_ctrl_fc//2+3,N_ctrl_fc//2+4,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][9]=[N_ctrl_cc//2,N_ctrl_fc//2+4,N_ctrl_fc//2+4,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][10]=[N_ctrl_cc//2,N_ctrl_fc//2+4,N_ctrl_fc//2+5,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][11]=[N_ctrl_cc//2,N_ctrl_fc//2+5,N_ctrl_fc//2+5,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][12]=[N_ctrl_cc//2,N_ctrl_fc//2+5,N_ctrl_fc//2+6,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][13]=[N_ctrl_cc//2,N_ctrl_fc//2+6,N_ctrl_fc//2+6,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][14]=[N_ctrl_cc//2,N_ctrl_fc//2+6,N_ctrl_fc//2+7,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][15]=[N_ctrl_cc//2,N_ctrl_fc//2+7,N_ctrl_fc//2+7,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][16]=[N_ctrl_cc//2,N_ctrl_fc//2+7,N_ctrl_fc//2+8,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][17]=[N_ctrl_cc//2,N_ctrl_fc//2+8,N_ctrl_fc//2+8,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][18]=[N_ctrl_cc//2,N_ctrl_fc//2+8,N_ctrl_fc//2+9,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][19]=[N_ctrl_cc//2,N_ctrl_fc//2+9,N_ctrl_fc//2+9,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][20]=[N_ctrl_cc//2,N_ctrl_fc//2+9,N_ctrl_fc//2+10,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][21]=[N_ctrl_cc//2,N_ctrl_fc//2+10,N_ctrl_fc//2+10,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][22]=[N_ctrl_cc//2,0,0,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][23]=[N_ctrl_cc//2+1,N_ctrl_fc,N_ctrl_fc,vm2.comblist[0][i],vm2.comblist[1][i]]
				#var_list[i-1][24]=[N_ctrl_cc,0,0,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list=[[[] for x in range(15)] for y in range(len(vm2.comblist[0])-1)] # change here!
				var_list[i-1][0]=[N_ctrl_cc//2,N_ctrl_fc//5,N_ctrl_fc//5,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][1]=[N_ctrl_cc//2,N_ctrl_fc*2//5,N_ctrl_fc*2//5,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][2]=[N_ctrl_cc//2,N_ctrl_fc*3//5,N_ctrl_fc*3//5,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][3]=[N_ctrl_cc//2,N_ctrl_fc*4//5,N_ctrl_fc*4//5,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][4]=[N_ctrl_cc//2,N_ctrl_fc,N_ctrl_fc,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][5]=[N_ctrl_cc//2+1,N_ctrl_fc//5,N_ctrl_fc//5,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][6]=[N_ctrl_cc//2+1,N_ctrl_fc*2//5,N_ctrl_fc*2//5,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][7]=[N_ctrl_cc//2+1,N_ctrl_fc*3//5,N_ctrl_fc*3//5,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][8]=[N_ctrl_cc//2+1,N_ctrl_fc*4//5,N_ctrl_fc*4//5,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][9]=[N_ctrl_cc//2+1,N_ctrl_fc,N_ctrl_fc,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][10]=[N_ctrl_cc//2+3,N_ctrl_fc//5,N_ctrl_fc//5,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][11]=[N_ctrl_cc//2+3,N_ctrl_fc*2//5,N_ctrl_fc*2//5,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][12]=[N_ctrl_cc//2+3,N_ctrl_fc*3//5,N_ctrl_fc*3//5,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][13]=[N_ctrl_cc//2+3,N_ctrl_fc*4//5,N_ctrl_fc*4//5,vm2.comblist[0][i],vm2.comblist[1][i]]
				var_list[i-1][14]=[N_ctrl_cc//2+3,N_ctrl_fc,N_ctrl_fc,vm2.comblist[0][i],vm2.comblist[1][i]]
	#===================================================================
			...
			if line[0:4]=='@L@W':
				...
				for ivt in range(len(var_list)):
					for ifcw in range(len(var_list[0])):
						...
						if FC_half==1:
							netmap2.get_net('fb',None,'d2oi',N_ctrl_fc,var_list[ivt][ifcw][2])
							netmap2.get_net('c1',None,'d2o',N_ctrl_cc,var_list[ivt][ifcw][0])	
							netmap2.get_net('vd',None,var_list[ivt][ifcw][3],var_list[ivt][ifcw][3],1)	 
							netmap2.get_net('tm',None,var_list[ivt][ifcw][4],var_list[ivt][ifcw][4],1)	 
...
def gen_result_old(result_dir,design_name,ncell,ndrv,nfc,nstg,num_meas,index,show,VDD,TEMP):
...
def gen_dltdc_pex_wrapper(extDir,netlistDir,format_dir,ncc,ndrv,nfc,nstg,ninterp,designName,fc_en_type, FC_half, pex_spectre, delay_clk_fb, delay_clk_ref, per_clk_fb, per_clk_ref,version):
	if version==1:
		r_netlist=open(format_dir+"/form_pex_wrapped_dltdc.sp","r")
	elif version==2 or version==3:
		r_netlist=open(format_dir+"/form_pex_wrapped_dltdc_v2.sp","r")
	w_netlist=open(netlistDir+"/"+"wrapped_"+designName+".sp","w")
	lines=list(r_netlist.readlines())
	...
	### delay of each clk ###
	netmap1.get_net('Df',None,delay_clk_fb,delay_clk_fb,1)	
	netmap1.get_net('Wf',None,per_clk_fb/2,per_clk_fb/2,1)	
	netmap1.get_net('Pf',None,per_clk_fb,per_clk_fb,1)	
	netmap1.get_net('Dr',None,delay_clk_ref,delay_clk_ref,1)	
	netmap1.get_net('Wr',None,per_clk_ref/2,per_clk_ref/2,1)	
	netmap1.get_net('Pr',None,per_clk_ref,per_clk_ref,1)	
	...
	if nfc!=0:
		...
		netmap1.get_net('vf',None,0,1,1)	
		netmap1.get_net('nf',None,0,1,1)
		netmap1.get_net('Vf',None,0,0,1) #for v2
	netmap1.get_net('vc',None,0,ncc*nstg-1,1)	
	netmap1.get_net('nc',None,0,ncc*nstg-1,1)	
	netmap1.get_net('Vc','vc',0,ncc*nstg-1,1) #for v2
	if version==2 or version==3:
		if nfc!=0:
			netmap1.get_net('VF',None,0,nfc*nstg-1,1)	
			netmap1.get_net('NF',None,0,nfc*nstg-1,1)
			netmap1.get_net('vF','vfr',0,nfc*nstg-1,1) #for v2
		elif nfc==0:	
			netmap1.get_net('VF',None,0,1,1)	
			netmap1.get_net('NF',None,0,1,1)
			netmap1.get_net('vF',None,0,0,1) #for v2
		netmap1.get_net('VC',None,0,ncc*nstg-1,1)	
		netmap1.get_net('NC',None,0,ncc*nstg-1,1)	
		netmap1.get_net('vC','vcr',0,ncc*nstg-1,1) #for v2
	...
	### write down the 'pex_wrapped_dltdc.sp' ###
	for line in lines:
		if line[0:3]=='xi4':
			line=line+'+ '+' '.join(inst_def_words)+'\n'
			netmap1.printline(line,w_netlist)	
...
def gen_tb_wrapped_dltdc(hspiceModel,tb_dir,format_dir,ncell,ndrv,nfc,nstg,vdd,temp,fc_en_type,sim_time,corner_lib,designName,netlistDir,finesim,single_ended,FC_half,pex_spectre,tapeout_mode, version):
	#=====================================================
	# model constants for trans simulation time calculation 
	#=====================================================
	if len(vdd)>1 and len(temp)>1:
	...
	if version==1:
		r_file=open(format_dir+"form_fs_pex_tb_dltdc.sp","r")
	elif version==2 or version==3:
		r_file=open(format_dir+"form_fs_pex_tb_dltdc_v2.sp","r")
	lines=list(r_file.readlines())
	...
	vm2.cal_nbigcy()
	vm2.combinate()  #vdd/temp combination
	for i in range(1,len(vm2.comblist[0])): # cc_fb, fc_fb, cc_ref, fc_ref
		var_list=[[[] for x in range(3)] for y in range(len(vm2.comblist[0])-1)]
	#	var_list[i-1][0]=[N_ctrl_cc-3*nstg,0,N_ctrl_cc,0,vm2.comblist[0][i],vm2.comblist[1][i]]
	#	var_list[i-1][1]=[N_ctrl_cc-2*nstg,0,N_ctrl_cc,0,vm2.comblist[0][i],vm2.comblist[1][i]]
		var_list[i-1][0]=[N_ctrl_cc-1*nstg,0,N_ctrl_cc,0,vm2.comblist[0][i],vm2.comblist[1][i]]
		var_list[i-1][1]=[N_ctrl_cc-1*nstg,N_ctrl_fc//2,N_ctrl_cc,0,vm2.comblist[0][i],vm2.comblist[1][i]]
		var_list[i-1][2]=[N_ctrl_cc-1*nstg,N_ctrl_fc,N_ctrl_cc,0,vm2.comblist[0][i],vm2.comblist[1][i]]
#		var_list[i-1][1]=[N_ctrl_cc,0,vm2.comblist[0][i],vm2.comblist[1][i]]
	#===================================================================
	#   DATA table gen for parametric sweep
	#===================================================================
	#----- lateral stuffs: names --------
	...
	if FC_half==1:
		netmap1.get_net('vb','vb',0,N_ctrl_fc-1,1) #for v2
	netmap1.get_net('vc','vc',0,N_ctrl_cc-1,1) #for v2
	netmap1.get_net('VF','vfr',0,N_ctrl_fc-1,1) #for v2
	netmap1.get_net('VC','vcr',0,N_ctrl_cc-1,1) #for v2
			...
			if line[0:4]=='@L@W':
				...
				for ivt in range(len(var_list)):
					for ifcw in range(len(var_list[0])):
						...
						netmap2.get_net('c1',None,'d2o',N_ctrl_cc,var_list[ivt][ifcw][0])	
						if version==2 or version==3: 
							netmap2.get_net('fr',None,'d2o',N_ctrl_fc,var_list[ivt][ifcw][3])	
							netmap2.get_net('cr',None,'d2o',N_ctrl_cc,var_list[ivt][ifcw][2])	 
							netmap2.get_net('vd',None,var_list[ivt][ifcw][4],var_list[ivt][ifcw][4],1) # vdd 
							netmap2.get_net('tm',None,var_list[ivt][ifcw][5],var_list[ivt][ifcw][5],1) # temp	
						elif version==1: 
							netmap2.get_net('vd',None,var_list[ivt][ifcw][2],var_list[ivt][ifcw][2],1) # vdd 
							netmap2.get_net('tm',None,var_list[ivt][ifcw][3],var_list[ivt][ifcw][3],1) # temp	
						netmap2.printline(line,w_file)
						w_file.write('\n')	 
...
def gen_result(result_dir,ncell,ndrv,nfc,nstg,num_meas,index,show,VDD,TEMP,fc_en_type):
	...
	for j in range(len(ncell)-1): # for all designs
		...
		try: # HSPICE/2016
			...
			print("failed => parsing: "+result_dir+'tb_dco_%dndrv_%dncc_%dnstg_%dnfc.mt0'%(ndrv[i],ncell[i],nstg[i],nfc[i]))
			try:
				r_result=open(result_dir+'tb_dco_%dndrv_%dncc_%dnstg_%dnfc.mt0'%(ndrv[i],ncell[i],nstg[i],nfc[i])) # for testing purpose
				for line in r_result.readlines():
					if il>skip_line-1:
						words=line.split()
						for word in words:
				...
				print("failed parsing result for tb_dco_%dndrv_%dncc_%dnstg_%dnfc.mt0"%(ndrv[i],ncell[i],nstg[i],nfc[i]))
				pass
	print (rm[0].vl[0][len(rm[0].vl[0])-4])
	print ("result_exist:")
	print (result_exist)	
	...
	idK=[[[[] for x in range(len(TEMP))] for y in range(len(VDD))] for z in range(len(ncell)-1)]
	print("#================================================")
	print("# INFO: parsed .mt0 files")
	print("#================================================")
	#for nd in range(len(ncell)-1):
	#for nd in range(1):
	for nd in result_exist:
		print("#------------------------------------------------")
		print("# INFO: post-processing results of dco_%dndrv_%dncc_%dnstg_%dnfc"%(dm[nd][0],dm[nd][1],dm[nd][2],dm[nd][3]))
		print("#------------------------------------------------")
		#print ("nd=%d"%(nd))
		#========================================
		# cc scaler for TW 
		...
		for j in range(len(rm[nd].vl[0][0])):       # for all command word
			...
			CC[vddIdx][tempIdx].append(cc)
			TW[vddIdx][tempIdx].append(cc*cc_fc_scale+fc)
			FREQ[vddIdx][tempIdx].append(freq)
			IAVG[vddIdx][tempIdx].append(iavg)
			K_ind[vddIdx][tempIdx].append(freq*float(N_stg)/(N_drv+cc/float(N_stg)))  #point individual constants 
			K_ind_pex[vddIdx][tempIdx].append(freq*float(N_stg))  #point individual constants: assuming Con dominates 
			fc=0
			cc=0
		#print("unsorted TW=")
		#print(TW)
