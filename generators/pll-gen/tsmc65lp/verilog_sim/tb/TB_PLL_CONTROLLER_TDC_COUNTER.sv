...
module TB_PLL_CONTROLLER_TDC_COUNTER();
	...
	parameter NDRV=10;
		...
		// ANALOG CORE
	parameter DCO_FBASE = 1.036299e+08;	//scale
		parameter DCO_OFFSET = 0;
		parameter DCO_CCW_MAX = NSTG*NCC-1;	//scale
	parameter DCO_CSTEP = 2.119144e+05;	//scale
		parameter DCO_FCW_MAX = NSTG*NFC-1;	//scale
	parameter DCO_FSTEP = 2.837365e+03;	//scale
...
//				.COARSE_LOCK_COUNT(coarse_lock_count),
	...
	// testBench
		...
		real clkref_period = 1/(1.000000e+07);  //Fref=0.01G => Fvco=2.5G
		real kp_real = 3.524397e+02;
		real ki_real = 3.524397e+00;
		integer multiply = 12;
		...
		// Initialize Everything
			...
			coarse_lock_threshold = 30;
			coarse_lock_count = 10;

				fine_lock_enable = 1;
			fine_lock_threshold = 10;
			fine_lock_count = 30;
