...
//	`include "functions.v"
	...
	// Local Parameters
		...
		localparam FCW_WIDTH = FCW_INT_WIDTH+FCW_FRAC_WIDTH;
	...
	//			 	TDC_ROUND_WIDTH-1:0] 	count_accum;
		wire 	[REF_ACCUM_WIDTH-
		      			FCW_FRAC_WIDTH-1:0] 	count_accum; // ble_test: COUNT_IN[3] is going to drive sigma_delta
	...
	tdc_counter	#(
			...
			.TDC_COUNT_ACCUM_WIDTH(REF_ACCUM_WIDTH-FCW_FRAC_WIDTH), // ble_test
