...
// testBench variables
	...
	real clkref_period = 1/(40e+06);  // ble_test 40MHz => 2.400250G
...
// Local Parameters
	...
	reg	[FCW_FRAC_WIDTH-1:0] 			fcw_frac; // ble_test
	...
	// Structural
		...
		// Initialize Everything
			...
			begin
				...
				fine_lock_threshold = 16*2**TDC_SHIFT; // 3.2GHz
