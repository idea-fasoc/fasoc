...
// ANALOG CORE
	parameter DCO_CENTER_FREQ = 7.900000e+08;	//scale
	parameter DCO_FBASE = 4.966832e+08;	//scale
	parameter DCO_OFFSET = 0;
	parameter DCO_CSTEP = 9.933664e+06;	// ble_test 
	parameter DCO_FSTEP = 1.831624e+04;	// ble_test 
