...
// testBench variables
	...
	real fcw_real;
	real fcw_frac_real;
	real clkref_period = 1/(1.000000e+07);  // ble_test 40MHz => 2.400250G
	real pre_fb_delay_0;
	real pre_fb_delay_1;
	real pre_fb_delay_2;
	real pre_fb_delay_3;
	...
	real sim_end = 0;
	real kp_real = 1.714326e+02; // int-N
	//real kp_real = 0.20;
...
// DCO parameters
	...
	parameter NCC=34;
	parameter NFC=12; // this is (N(one-hot) x N(thermal)) (3 x 112) because FSTEP is the one-hot value, and we want the same effective range 
