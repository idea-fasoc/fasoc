...
module tdc_encoder (
	...
	// Behavioral
		...
		// Convert sampled phases to binary
			...
			always @* begin		
				case (EMBTDC_RAW_OUT)
					5'b01011: begin	embtdc_idx = 0; retime_edge_sel <= 0; retime_lag <= 0; end	
					5'b01001: begin	embtdc_idx = 1; retime_edge_sel <= 0; retime_lag <= 0; end	
					5'b01101: begin	embtdc_idx = 2; retime_edge_sel <= 0; retime_lag <= 0; end	
					5'b00101: begin	embtdc_idx = 3; retime_edge_sel <= 1; retime_lag <= 0; end	
					5'b10101: begin	embtdc_idx = 4; retime_edge_sel <= 1; retime_lag <= 0; end	
					5'b10100: begin	embtdc_idx = 5; retime_edge_sel <= 1; retime_lag <= 0; end	
					5'b10110: begin	embtdc_idx = 6; retime_edge_sel <= 1; retime_lag <= 0; end	
					5'b10010: begin	embtdc_idx = 7; retime_edge_sel <= 0; retime_lag <= 1; end	
					5'b11010: begin	embtdc_idx = 8; retime_edge_sel <= 0; retime_lag <= 1; end	
					5'b01010: begin	embtdc_idx = 9; retime_edge_sel <= 0; retime_lag <= 1; end	
